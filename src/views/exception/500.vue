  ...
  <section class="bg-white dark:bg-gray-900 ">
    <div class="container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
      <div class="wf-ull lg:w-1/2">
        ...
        <h1 class="mt-3 text-2xl font-semibold text-gray-800 dark:text-white md:text-3xl">Internal Server Error</h1>
        <p class="mt-4 text-gray-500 dark:text-gray-400">Sorry, Your request could not be completed. A server error occurred while processing your request. Here are some helpful links:</p>
