          ...
          <div>
            ...
            <div class="mt-2 flex items-center">
              <span class="inline-block h-12 w-12 overflow-hidden rounded-full bg-gray-100">
                <img width="36" height="36" class="h-full w-full" :src="userInfo.avatar" alt="" />
              </span>
          ...
          <div class="w-1/2">
            <div class="col-span-3 sm:col-span-2">
              ...
              <div class="mt-2 flex rounded-md shadow-sm">
                <input v-model="userInfo.username" type="text" name="username" id="username"
          ...
          <div>
            ...
            <div class="mt-2 flex items-center">
              <button type="button"
                ...
                @click="subscription = 0" :class="[
                  subscription == 0
                    ? 'bg-gray-50 dark:bg-white'
                    : 'bg-white dark:bg-gray-800',
                ]">
                <span :class="[subscription == 0 ? 'bg-green-400' : 'bg-gray-200']"
              ...
              <button @click="subscription = 1" type="button"
                ...
                <span class="inline-block h-2 w-2 flex-shrink-0 rounded-full"
                  :class="[subscription == 1 ? 'bg-green-400' : 'bg-gray-200']" aria-hidden="true" />
